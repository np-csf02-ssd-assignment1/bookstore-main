...
namespace WebFrontend.Pages.Admin.Roles
{
    public class ManageModel : PageModel
    {
        ...
        public ManageModel(WebFrontend.Areas.Identity.Data.WebFrontendIdentityDbContext context,
       UserManager<ApplicationUser> userManager, RoleManager<ApplicationRole> roleManager)
        ...
        public async Task<IActionResult> OnPostAsync(string selectedusername, string selectedrolename)
        {
            ...
            ApplicationUser AppUser = (ApplicationUser)_context.Users.SingleOrDefault(u => u.UserName == selectedusername);
       ...
       delrolename)
        {
            ...
            ApplicationUser user = (ApplicationUser)_context.Users.Where(u => u.UserName.Equals(delusername, StringComparison.CurrentCultureIgnoreCase)).FirstOrDefault();
